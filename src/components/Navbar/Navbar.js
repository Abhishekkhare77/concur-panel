                ...
                <>
                    <Theme theme="g100">
                        <Header aria-label="IBM Platform Name">
                            ...
                            >
                                <SideNavItems>
                                    <SideNavMenu renderIcon={Fade16} title="Policy Management">
                                        <SideNavMenuItem href="#">Privacy Notices</SideNavMenuItem>
                                        <SideNavMenuItem aria-current="page" href="#">Templates</SideNavMenuItem>
                                    </SideNavMenu>
