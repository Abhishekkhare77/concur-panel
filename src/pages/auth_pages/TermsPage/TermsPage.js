      ...
      <section className="container">
        ...
        <div className="container__content">
          ...
          <fieldset className="cds--fieldset">
            <Checkbox labelText="I read all the terms and condition of this website" id="checked-2" />
          </fieldset>
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between' }} className="container__nav">
          <Link to={'/login'}><Button kind='danger'>Reject</Button></Link>
